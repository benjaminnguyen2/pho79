<template>
  <div class="main-section">
    <div class="content-wrapper menu-wrapper">
      ...
      <div class="food-item">
        <div class="item-name">
          <h2 style="font-weight: 700; width: 80%">P6: Phở Bắp Bò</h2>
          <h2 style="width: 20%; font-weight: 700">$14/$16</h2>
        </div>
        <p>Beef shank rice noodle soup</p>
      </div>
      <div class="food-item">
        <div class="item-name">
          <h2 style="font-weight: 700; width: 80%">P7: Phở Đặc Biệt</h2>
          <h2 style="width: 20%; font-weight: 700">$16/$18</h2>
        </div>
